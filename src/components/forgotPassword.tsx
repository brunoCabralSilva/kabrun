...
export default function ForgotPassword() {
  ...
  return (
    <div className="break-words z-50 fixed top-0 left-0 w-full flex items-center justify-center bg-black/80 px-3 sm:px-0 overflow-y-auto h-full">
      <div className="bg-black break-words w-11/12 md:w-1/2 flex flex-col justify-center items-center relative border-red-500 border-2 pb-5 bg-dice bg-ritual bg-cover">
